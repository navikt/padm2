...
val SAR_TSS_MISS_COUNTER: Counter = Counter.build()
    .namespace(METRICS_NS)
    .name("SAR_TSS_MISS_COUNTER")
    .help("Counts the number of times we can't find a TSS-ident")
    .register()

val NETWORK_CALL_SUMMARY: Summary = Summary.build()
    .namespace(METRICS_NS)
...
val SANITIZE_INVALID_CHAR_COUNTER: Counter = Counter.build()
    .name(METRICS_NS)
    .name("SANITIZE_INVALID_CHAR_COUNTER")
    .help("Counts the number of encountered illegal chars from sanitation")
    .register()
