...
enum class DialogmeldingKodeverk(
    ...
    SVAR_PAA_INNKALLING_DIALOGMOTE_JEG_ONSKER_NY_TID(
        "2.16.578.1.12.4.1.1.8126",
        "Jeg ønsker nytt møtetidspunkt",
        "2",
        "1",
        "12",
        "Svar innkalling dialogmøte:Jeg ønsker nytt møtetidspunkt"
    ),
    SVAR_PAA_INNKALLING_DIALOGMOTE_NEI_JEG_KAN_IKKE_KOMME(
        "2.16.578.1.12.4.1.1.8126",
        "Jeg kan ikke komme / begrunnelse for manglende oppmøte",
        "3",
        "1",
        "13",
        "Svar innkalling dialogmøte:Jeg kan ikke komme, se begrunnelse"
    ),
    FORESPORSEL_OM_PASIENT_FORESPORSEL_OM_PASIENT(
    ...
    FORESPORSEL_OM_PASIENT_PAAMINNELSE_FORESPORSEL_OM_PASIENT(
        "2.16.578.1.12.4.1.1.8129",
    ...
    OVERFORING_EPJ_INFORMASJON_SVAR_PAA_FORESPORSEL_OM_PASIENT(
        "2.16.578.1.12.4.1.1.9069",
        "Svar på forespørsel",
        "5",
        "2",
        "25",
    ...
    HENVENDELSE_OM_PASIENT_HENVENDELSE_OM_SYKEFRAVARSOPPFOLGING(
    ...
    HENVENDELSE_OM_PASIENT_HENVENDELSE_IKKE_SYKMELDT_PASIENT(
        "2.16.578.1.12.4.1.1.8128",
